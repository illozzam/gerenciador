...
class Mensagem(models.Model):
	remetente = models.ForeignKey(Usuario, related_name='remetente', on_delete=models.CASCADE)
...
class Tarefa(models.Model):
	...
	usuarioOrigem = models.ForeignKey(Usuario, verbose_name='Adicionado por', related_name='usuarioOrigem', on_delete=models.CASCADE)
	usuarioDestino = models.ForeignKey(Usuario, verbose_name='Usuário destino', related_name='usuarioDestino', on_delete=models.CASCADE)
...
class Consultoria(models.Model):
	...
	ramoAtividade = models.ForeignKey(RamoConsultoria, null=True, blank=True, verbose_name='Ramo de Atividade', on_delete=models.SET_NULL)
